...
customers = [
    Customer(email="jd101a@american.edu", password=hashed_password, name="John Doe", daily_calories_goal=2800, per_meal_calories_limit=1000, is_admin=True),
    Customer(email="jack@american.edu", password=hashed_password, name="Jack Cai", daily_calories_goal=5000, per_meal_calories_limit=2000),
]
...
menuItems = [
    ...
    MenuItem(name="California Burger", price=12.05, calories=710, restaurant_id=6),
    MenuItem(name="Classic Americana Burger", price=9.45, calories=710, restaurant_id=6),
    MenuItem(name="Cheeseburger", price=9.45, calories=600, restaurant_id=6),
    MenuItem(name="Hamburger", price=9.45, calories=375, restaurant_id=6),
    MenuItem(name="Pulled Pork Burger", price=12.05, calories=630, restaurant_id=6),
    MenuItem(name="Brisket Burger", price=12.05, calories=630, restaurant_id=6),
    MenuItem(name="Chipotle Chicken Club Flatbread", price=7.99, calories=670, restaurant_id=7),
    MenuItem(name="BBQ Bacon Chicken Flatbread", price=7.99, calories=660, restaurant_id=7),
    MenuItem(name="BBQ Bacon Chicken Flatbread", price=7.99, calories=660, restaurant_id=7),
    MenuItem(name="Pesto Chicken Flatbread", price=7.99, calories=600, restaurant_id=7),
    MenuItem(name="Santa Fe Flatbread", price=7.99, calories=720, restaurant_id=7),
    MenuItem(name="Nashville Hot! Flatbread", price=7.99, calories=580, restaurant_id=7),
    MenuItem(name="KC BBQ Rice Bowl", price=7.95, calories=610, restaurant_id=7),
    MenuItem(name="Baja Queso Rice Bowl", price=7.95, calories=680, restaurant_id=7),
    MenuItem(name="Buffalo Chicken Rice Bowl", price=7.95, calories=600, restaurant_id=7),
    MenuItem(name="Mexican Rice Bowl", price=7.95, calories=710, restaurant_id=7),
    MenuItem(name="Power Protein Rice Bowl", price=7.95, calories=700, restaurant_id=7),
    MenuItem(name="Frito Grande Rice Bowl", price=7.95, calories=630, restaurant_id=7),
    MenuItem(name="Meatless Mexican Rice Bowl", price=7.95, calories=730, restaurant_id=7),
    MenuItem(name="Roadhouse BBQ Chicken Salad", price=10.49, calories=420, restaurant_id=7),
    MenuItem(name="Southwest Chipotle Chicken Salad", price=10.49, calories=480, restaurant_id=7),
    MenuItem(name="Chicken Avocado Cobb Salad", price=10.49, calories=600, restaurant_id=7),
    MenuItem(name="Buffalo Chicken Salad", price=10.49, calories=380, restaurant_id=7),
    MenuItem(name="Strawberry & Kale Salad", price=10.49, calories=530, restaurant_id=7),
    MenuItem(name="Buffalo Chicken Salad", price=10.49, calories=380, restaurant_id=7),
    MenuItem(name="Chicken Caesar Salad", price=10.49, calories=510, restaurant_id=7),
    MenuItem(name="Chicken Avocado Toasted Wrap", price=7.35, calories=570, restaurant_id=7),
    MenuItem(name="Wild Strawberry Smoothie - Small", price=4.95, calories=240, restaurant_id=7),
    MenuItem(name="Wild Strawberry Smoothie - Medium", price=6.35, calories=450, restaurant_id=7),
    MenuItem(name="Caribbean Craze Smoothie - Small", price=4.95, calories=230, restaurant_id=7),
    MenuItem(name="Caribbean Craze Smoothie - Medium", price=6.35, calories=440, restaurant_id=7),
    MenuItem(name="Maui Mango Smoothie - Small", price=4.95, calories=280, restaurant_id=7),
    MenuItem(name="Maui Mango Smoothie - Medium", price=6.35, calories=560, restaurant_id=7),
    MenuItem(name="Tropical Therapy Smoothie - Small", price=4.95, calories=320, restaurant_id=7),
    MenuItem(name="Tropical Therapy Smoothie - Medium", price=6.35, calories=570, restaurant_id=7),
    MenuItem(name="Mango Me Crazy Smoothie - Small", price=4.95, calories=250, restaurant_id=7),
    MenuItem(name="Mango Me Crazy Smoothie - Medium", price=6.35, calories=460, restaurant_id=7),
    MenuItem(name="Bangin' Berry Smoothie - Small", price=4.95, calories=260, restaurant_id=7),
    MenuItem(name="Bangin' Berry Smoothie - Medium", price=6.35, calories=490, restaurant_id=7),
    MenuItem(name="Peach on the Beach Smoothie - Small", price=5.15, calories=260, restaurant_id=7),
    MenuItem(name="Peach on the Beach Smoothie - Medium", price=6.25, calories=500, restaurant_id=7),
    MenuItem(name="Goin' Green Smoothie - Small", price=5.15, calories=230, restaurant_id=7),
    MenuItem(name="Goin' Green Smoothie - Medium", price=6.58, calories=420, restaurant_id=7),
    MenuItem(name="Acai Banana Berry Bowl", price=7.89, calories=580, restaurant_id=7),
    MenuItem(name="Acai Peanut Butter Bowl", price=7.89, calories=640, restaurant_id=7),
    MenuItem(name="Buffalo Chicken Artisan Melt", price=7.99, calories=1020, restaurant_id=7),
    MenuItem(name="Chicken Caprese Artisan Melt", price=7.99, calories=940, restaurant_id=7),
    MenuItem(name="Chicken Bacon Ranch Artisan Melt", price=7.99, calories=1070, restaurant_id=7),
    MenuItem(name="Grilled Cheese & Bacon Artisan Melt", price=6.99, calories=1220, restaurant_id=7),
    MenuItem(name="Mom's Grilled Cheese Artisan Melt", price=5.99, calories=1160, restaurant_id=7),
    MenuItem(name="Chicken Avocado Crunchadilla", price=7.59, calories=650, restaurant_id=7),
    MenuItem(name="Supreme Crunchadilla", price=7.59, calories=710, restaurant_id=7),
    MenuItem(name="On The Border Crunchadilla", price=7.59, calories=670, restaurant_id=7),
    MenuItem(name="The Cowboy Crunchadilla", price=7.59, calories=640, restaurant_id=7),
    MenuItem(name="Chicken Bacon Ranch Crunchadilla", price=7.59, calories=690, restaurant_id=7),
